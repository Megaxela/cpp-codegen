...
class ToStringConversion(BasicConversion):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._header_template = self._load_template("to_string_header.jinja2")
        self._source_template = self._load_template("to_string_source.jinja2")
